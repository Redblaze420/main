...
void drivers_init() {
  ...
  mpu_reconfig(MPU_MODE_BOARDLOADER);  // !@# should be inside
                                       // parse_boardloader_capabilities???
  parse_boardloader_capabilities();
  mpu_reconfig(MPU_MODE_DEFAULT);

  mpu_reconfig(MPU_MODE_OTP);  // !@# should be inside uni_variant_init???
  unit_variant_init();
  mpu_reconfig(MPU_MODE_DEFAULT);
  ...
  mpu_reconfig(MPU_MODE_OTP);  // !@# should be inside entropy_init???
  entropy_init();
  mpu_reconfig(MPU_MODE_DEFAULT);
