...
from .helpers import address_from_bytes, decode_typed_data, format_ethereum_amount, get_account_and_path
...
async def require_confirm_tx(
    ...
    await confirm_ethereum_tx(
        to_str, total_amount, account, account_path, maximum_fee, fee_info_items, chunkify=chunkify
    )
